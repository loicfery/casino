...
public class ActionSplit implements ActionBlackJack {
    ...
    public void action(List<UserHand> listOfUserHand, CardPackage card_package, Bet bet) {
        ...
        User userSplit = new User(listOfUserHand.get(1).getUser().getUserName(),listOfUserHand.get(1).getUser().getEmail(),listOfUserHand.get(1).getUser().getRank(),0,0,new Database());
